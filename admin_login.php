...
if (isset($_POST['submit'])) {
    $admin_mobile = $_POST['st_mobile'];
    $admin_password = $_POST['st_password'];

    try {
        // Use prepared statements to prevent SQL injection
        $stmt = $pdo->prepare("SELECT * FROM admin WHERE admin_mobile = :mobile AND admin_password = :password");
        $stmt->bindParam(':mobile', $admin_mobile);
