                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">
                                    <a href="add_department.php" class="btn btn-block btn-warning btn-sm">Add Department</a>
                                </li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $stmt->fetch()) {
                                            $my_dept = $row['dept_name'];
                                   // $i = 0;        
                                        ?>

                                            <tr>
                                                <td><?php echo ++$i ?>.</td>
                                                <td><?php echo $my_dept ?></td>
                                                <td>
                                                    <div class="">
                                                        <div style="width: 55%">
                                                            <a href="class_edit.php" class="btn btn-primary">Edit</a>
                                                            <a href="class_delete.php" class="btn btn-danger">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
